...
class PedidoSerializerPOST(serializers.ModelSerializer):
    ...
    class Meta:
        model = Pedido
        fields = ['pedido_fech','pedido_nro','pedido_estado','usu_id','mesa_id','pedidoplatos']
...
class PedidoSerializerGET(serializers.ModelSerializer):
    ...
    class Meta:
        model = Pedido
        fields = ['pedido_fech','pedido_nro','pedido_estado','usu_id','pedido_id','usu_id','mesa_id','pedidoplatos']
