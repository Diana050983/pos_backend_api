# Generated by Django 3.2 on 2023-09-04 01:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido_estado', models.CharField(choices=[('solicitado', 'SOLICITADO'), ('entregado', 'ENTREGADO')], default='solicitado', max_length=100)),
