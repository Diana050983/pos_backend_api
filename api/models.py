...
class Plato(models.Model):
    ...
    categoria_id = models.ForeignKey(Categoria,related_name='Platos',db_column='categoria_id',on_delete=models.RESTRICT,verbose_name='Categoria')
...
class Pedido(models.Model):
    ...
    pedido_estado = models.CharField(max_length=100,default='solicitado',choices=ESTADO_CHOICES)
    mesa_id = models.ForeignKey(Mesa,to_field='mesa_id',on_delete=models.RESTRICT,db_column='mesa_id')
    usu_id = models.ForeignKey(User,to_field='id',related_name='Pedidos',on_delete=models.RESTRICT,db_column='usu_id')
...
class PedidoPlato(models.Model):    
    ...
    plato_id = models.ForeignKey(Plato,related_name='pedidosplatos',to_field='plato_id',db_column='plato_id',on_delete=models.RESTRICT)
    pedido_id = models.ForeignKey(Pedido,related_name='pedidoplatos',to_field='pedido_id',db_column='pedido_id',on_delete=models.RESTRICT,null=True)
