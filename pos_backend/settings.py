...
SECRET_KEY = 'django-insecure-xryevei2fo7t-p^)vu2eo1rs*@bxnedklk$!8t^2vdmfte^^=m'
...
cloudinary.config( 
  cloud_name = "dl4vrfij2", 
  api_key = "249359919171786", 
  api_secret = "_fy-fcdDEbRLebyrKdj1HZik_GA" 
)
